          ...
          acc[bookmarkId] = {
            ...
            githubProject: row.githubProjects
              ? {
                  ...
                  agentTags: row.githubProjects.agentTags,
                  valueScore: row.githubProjects.valueScore,
                  archived: row.githubProjects.archived,
                  archiveReason: row.githubProjects.archiveReason,
                  pushedAt: row.githubProjects.pushedAt,
                  lastFetchedAt: row.githubProjects.lastFetchedAt,
                  aiStatus: row.githubProjects.aiStatus,
                }
              : undefined,
          };
        }
